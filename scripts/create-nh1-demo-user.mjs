...
const DEMO = {
  email:"nh1.demo@civix250.com", password:"NH1-Demo-2026!",
  full_name:"NH Demo Citizen 1", role:"citizen",
  district:"NH-01", state:"New Hampshire",
  street_address:"107 North Main St", city:"Concord", zip_code:"03301",
};
async function main(){
  let userId=null;
