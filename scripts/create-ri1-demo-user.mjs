...
const DEMO = {
  email:"ri1.demo@civix250.com", password:"RI1-Demo-2026!",
  full_name:"RI Demo Citizen 1", role:"citizen",
  district:"RI-01", state:"Rhode Island",
  street_address:"82 Smith St", city:"Providence", zip_code:"02903",
};
async function main(){
  let userId=null;
