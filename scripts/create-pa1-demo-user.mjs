...
const DEMO = {
  email:"pa1.demo@civix250.com", password:"PA1-Demo-2026!",
  full_name:"PA Demo Citizen 1", role:"citizen",
  district:"PA-01", state:"Pennsylvania",
  street_address:"10 E Court St", city:"Doylestown", zip_code:"18901",
};
async function main(){
  let userId=null;
