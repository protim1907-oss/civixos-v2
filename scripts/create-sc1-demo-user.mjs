...
const DEMO = {
  email:"sc1.demo@civix250.com", password:"SC1-Demo-2026!",
  full_name:"SC Demo Citizen 1", role:"citizen",
  district:"SC-01", state:"South Carolina",
  street_address:"80 Broad St", city:"Charleston", zip_code:"29401",
};
async function main(){
  let userId=null;
