...
const DEMO = {
  email:"id1.demo@civix250.com", password:"ID1-Demo-2026!",
  full_name:"ID Demo Citizen 1", role:"citizen",
  district:"ID-01", state:"Idaho",
  street_address:"700 W Jefferson St", city:"Boise", zip_code:"83702",
};
async function main(){
  let userId=null;
