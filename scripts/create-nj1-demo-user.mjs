...
const DEMO = {
  email:"nj1.demo@civix250.com", password:"NJ1-Demo-2026!",
  full_name:"NJ Demo Citizen 1", role:"citizen",
  district:"NJ-01", state:"New Jersey",
  street_address:"520 Market St", city:"Camden", zip_code:"08102",
};
async function main(){
  let userId=null;
