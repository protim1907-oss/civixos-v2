...
const DEMO = {
  email:"fl1.demo@civix250.com", password:"FL1-Demo-2026!",
  full_name:"FL Demo Citizen 1", role:"citizen",
  district:"FL-01", state:"Florida",
  street_address:"223 Palafox Pl", city:"Pensacola", zip_code:"32502",
};
async function main(){
  let userId=null;
