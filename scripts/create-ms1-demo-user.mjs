...
const DEMO = {
  email:"ms1.demo@civix250.com", password:"MS1-Demo-2026!",
  full_name:"MS Demo Citizen 1", role:"citizen",
  district:"MS-01", state:"Mississippi",
  street_address:"400 High St", city:"Jackson", zip_code:"39201",
};
async function main(){
  let userId=null;
