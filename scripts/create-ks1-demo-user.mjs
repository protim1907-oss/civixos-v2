...
const DEMO = {
  email:"ks1.demo@civix250.com", password:"KS1-Demo-2026!",
  full_name:"KS Demo Citizen 1", role:"citizen",
  district:"KS-01", state:"Kansas",
  street_address:"300 SW 10th Ave", city:"Topeka", zip_code:"66612",
};
async function main(){
  let userId=null;
