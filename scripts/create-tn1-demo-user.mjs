...
const DEMO = {
  email:"tn1.demo@civix250.com", password:"TN1-Demo-2026!",
  full_name:"TN Demo Citizen 1", role:"citizen",
  district:"TN-01", state:"Tennessee",
  street_address:"200 W Center St", city:"Kingsport", zip_code:"37660",
};
async function main(){
  let userId=null;
