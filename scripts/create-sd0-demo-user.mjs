...
const DEMO = {
  email:"sd0.demo@civix250.com", password:"SD0-Demo-2026!",
  full_name:"SD At-Large Demo", role:"citizen",
  district:"SD-00", state:"South Dakota",
  street_address:"500 E Capitol Ave", city:"Pierre", zip_code:"57501",
};
async function main(){
  let userId=null;
