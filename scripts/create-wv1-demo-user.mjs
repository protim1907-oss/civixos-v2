...
const DEMO = {
  email:"wv1.demo@civix250.com", password:"WV1-Demo-2026!",
  full_name:"WV Demo Citizen 1", role:"citizen",
  district:"WV-01", state:"West Virginia",
  street_address:"1900 Kanawha Blvd E", city:"Charleston", zip_code:"25305",
};
async function main(){
  let userId=null;
