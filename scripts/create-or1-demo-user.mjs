...
const DEMO = {
  email:"or1.demo@civix250.com", password:"OR1-Demo-2026!",
  full_name:"OR Demo Citizen 1", role:"citizen",
  district:"OR-01", state:"Oregon",
  street_address:"150 E Main St", city:"Hillsboro", zip_code:"97123",
};
async function main(){
  let userId=null;
