...
const DEMO = {
  email:"wi1.demo@civix250.com", password:"WI1-Demo-2026!",
  full_name:"WI Demo Citizen 1", role:"citizen",
  district:"WI-01", state:"Wisconsin",
  street_address:"18 N Jackson St", city:"Janesville", zip_code:"53545",
};
async function main(){
  let userId=null;
