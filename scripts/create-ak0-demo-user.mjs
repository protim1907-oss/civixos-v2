...
const DEMO = {
  email:"ak0.demo@civix250.com", password:"AK0-Demo-2026!",
  full_name:"AK At-Large Demo", role:"citizen",
  district:"AK-00", state:"Alaska",
  street_address:"120 4th St", city:"Juneau", zip_code:"99801",
};
async function main(){
  let userId=null;
