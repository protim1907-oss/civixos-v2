...
const DEMO = {
  email:"de0.demo@civix250.com", password:"DE0-Demo-2026!",
  full_name:"DE At-Large Demo", role:"citizen",
  district:"DE-00", state:"Delaware",
  street_address:"150 Martin Luther King Jr Blvd S", city:"Dover", zip_code:"19901",
};
async function main(){
  let userId=null;
