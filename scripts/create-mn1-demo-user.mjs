...
const DEMO = {
  email:"mn1.demo@civix250.com", password:"MN1-Demo-2026!",
  full_name:"MN Demo Citizen 1", role:"citizen",
  district:"MN-01", state:"Minnesota",
  street_address:"201 4th St SE", city:"Rochester", zip_code:"55904",
};
async function main(){
  let userId=null;
