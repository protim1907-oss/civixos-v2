...
const DEMO = {
  email:"ar1.demo@civix250.com", password:"AR1-Demo-2026!",
  full_name:"AR Demo Citizen 1", role:"citizen",
  district:"AR-01", state:"Arkansas",
  street_address:"500 Woodlane St", city:"Little Rock", zip_code:"72201",
};
async function main(){
  let userId=null;
