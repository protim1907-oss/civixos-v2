...
const DEMO = {
  email:"in1.demo@civix250.com", password:"IN1-Demo-2026!",
  full_name:"IN Demo Citizen 1", role:"citizen",
  district:"IN-01", state:"Indiana",
  street_address:"5925 Calumet Ave", city:"Hammond", zip_code:"46320",
};
async function main(){
  let userId=null;
