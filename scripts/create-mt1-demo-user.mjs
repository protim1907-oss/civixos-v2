...
const DEMO = {
  email:"mt1.demo@civix250.com", password:"MT1-Demo-2026!",
  full_name:"MT Demo Citizen 1", role:"citizen",
  district:"MT-01", state:"Montana",
  street_address:"1301 E 6th Ave", city:"Helena", zip_code:"59601",
};
async function main(){
  let userId=null;
