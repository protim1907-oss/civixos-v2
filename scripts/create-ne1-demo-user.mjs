...
const DEMO = {
  email:"ne1.demo@civix250.com", password:"NE1-Demo-2026!",
  full_name:"NE Demo Citizen 1", role:"citizen",
  district:"NE-01", state:"Nebraska",
  street_address:"1445 K St", city:"Lincoln", zip_code:"68508",
};
async function main(){
  let userId=null;
