...
const DEMO = {
  email:"nd0.demo@civix250.com", password:"ND0-Demo-2026!",
  full_name:"ND At-Large Demo", role:"citizen",
  district:"ND-00", state:"North Dakota",
  street_address:"600 E Boulevard Ave", city:"Bismarck", zip_code:"58505",
};
async function main(){
  let userId=null;
