...
const DEMO = {
  email:"nc1.demo@civix250.com", password:"NC1-Demo-2026!",
  full_name:"NC Demo Citizen 1", role:"citizen",
  district:"NC-01", state:"North Carolina",
  street_address:"201 W 1st St", city:"Greenville", zip_code:"27858",
};
async function main(){
  let userId=null;
