...
const DEMO = {
  email:"ma1.demo@civix250.com", password:"MA1-Demo-2026!",
  full_name:"MA Demo Citizen 1", role:"citizen",
  district:"MA-01", state:"Massachusetts",
  street_address:"36 Court St", city:"Springfield", zip_code:"01103",
};
async function main(){
  let userId=null;
