...
const DEMO = {
  email:"va1.demo@civix250.com", password:"VA1-Demo-2026!",
  full_name:"VA Demo Citizen 1", role:"citizen",
  district:"VA-01", state:"Virginia",
  street_address:"100 Duke of Gloucester St", city:"Williamsburg", zip_code:"23185",
};
async function main(){
  let userId=null;
