...
const DEMO = {
  email:"ct1.demo@civix250.com", password:"CT1-Demo-2026!",
  full_name:"CT Demo Citizen 1", role:"citizen",
  district:"CT-01", state:"Connecticut",
  street_address:"550 Main St", city:"Hartford", zip_code:"06103",
};
async function main(){
  let userId=null;
