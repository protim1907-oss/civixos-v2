...
const DEMO = {
  email:"ok1.demo@civix250.com", password:"OK1-Demo-2026!",
  full_name:"OK Demo Citizen 1", role:"citizen",
  district:"OK-01", state:"Oklahoma",
  street_address:"2300 N Lincoln Blvd", city:"Oklahoma City", zip_code:"73105",
};
async function main(){
  let userId=null;
