...
const DEMO = {
  email:"nm1.demo@civix250.com", password:"NM1-Demo-2026!",
  full_name:"NM Demo Citizen 1", role:"citizen",
  district:"NM-01", state:"New Mexico",
  street_address:"490 Old Santa Fe Trail", city:"Santa Fe", zip_code:"87501",
};
async function main(){
  let userId=null;
