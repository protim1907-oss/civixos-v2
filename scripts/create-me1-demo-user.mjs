...
const DEMO = {
  email:"me1.demo@civix250.com", password:"ME1-Demo-2026!",
  full_name:"ME Demo Citizen 1", role:"citizen",
  district:"ME-01", state:"Maine",
  street_address:"210 State St", city:"Augusta", zip_code:"04330",
};
async function main(){
  let userId=null;
