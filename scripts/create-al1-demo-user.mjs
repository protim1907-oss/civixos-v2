...
const DEMO = {
  email:"al1.demo@civix250.com", password:"AL1-Demo-2026!",
  full_name:"AL Demo Citizen 1", role:"citizen",
  district:"AL-01", state:"Alabama",
  street_address:"205 Government St", city:"Mobile", zip_code:"36602",
};
async function main(){
  let userId=null;
