...
const DEMO = {
  email:"ky1.demo@civix250.com", password:"KY1-Demo-2026!",
  full_name:"KY Demo Citizen 1", role:"citizen",
  district:"KY-01", state:"Kentucky",
  street_address:"300 S 5th St", city:"Paducah", zip_code:"42003",
};
async function main(){
  let userId=null;
