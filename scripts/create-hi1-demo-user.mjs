...
const DEMO = {
  email:"hi1.demo@civix250.com", password:"HI1-Demo-2026!",
  full_name:"HI Demo Citizen 1", role:"citizen",
  district:"HI-01", state:"Hawaii",
  street_address:"415 S Beretania St", city:"Honolulu", zip_code:"96813",
};
async function main(){
  let userId=null;
