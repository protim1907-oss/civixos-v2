...
const DEMO = {
  email:"mo1.demo@civix250.com", password:"MO1-Demo-2026!",
  full_name:"MO Demo Citizen 1", role:"citizen",
  district:"MO-01", state:"Missouri",
  street_address:"1520 Market St", city:"St. Louis", zip_code:"63103",
};
async function main(){
  let userId=null;
