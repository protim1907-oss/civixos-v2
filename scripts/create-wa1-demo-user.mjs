...
const DEMO = {
  email:"wa1.demo@civix250.com", password:"WA1-Demo-2026!",
  full_name:"WA Demo Citizen 1", role:"citizen",
  district:"WA-01", state:"Washington",
  street_address:"1600 Cornwall Ave", city:"Bellingham", zip_code:"98225",
};
async function main(){
  let userId=null;
