...
const DEMO = {
  email:"ia1.demo@civix250.com", password:"IA1-Demo-2026!",
  full_name:"IA Demo Citizen 1", role:"citizen",
  district:"IA-01", state:"Iowa",
  street_address:"1007 E Grand Ave", city:"Des Moines", zip_code:"50319",
};
async function main(){
  let userId=null;
