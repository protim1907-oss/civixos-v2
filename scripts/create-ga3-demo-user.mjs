...
const DEMO = {
  email:"ga3.demo@civix250.com", password:"GA3-Demo-2026!",
  full_name:"GA Demo Citizen 3", role:"citizen",
  district:"GA-03", state:"Georgia",
  street_address:"25 Jackson St", city:"Newnan", zip_code:"30263",
};
async function main(){
  let userId=null;
