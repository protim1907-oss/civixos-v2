...
const DEMO = {
  email:"vt0.demo@civix250.com", password:"VT0-Demo-2026!",
  full_name:"VT At-Large Demo", role:"citizen",
  district:"VT-00", state:"Vermont",
  street_address:"109 State St", city:"Montpelier", zip_code:"05609",
};
async function main(){
  let userId=null;
