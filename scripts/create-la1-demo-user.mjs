...
const DEMO = {
  email:"la1.demo@civix250.com", password:"LA1-Demo-2026!",
  full_name:"LA Demo Citizen 1", role:"citizen",
  district:"LA-01", state:"Louisiana",
  street_address:"3330 N Causeway Blvd", city:"Metairie", zip_code:"70002",
};
async function main(){
  let userId=null;
