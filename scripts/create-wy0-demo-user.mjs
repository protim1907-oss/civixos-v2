...
const DEMO = {
  email:"wy0.demo@civix250.com", password:"WY0-Demo-2026!",
  full_name:"WY At-Large Demo", role:"citizen",
  district:"WY-00", state:"Wyoming",
  street_address:"2020 Carey Ave", city:"Cheyenne", zip_code:"82002",
};
async function main(){
  let userId=null;
