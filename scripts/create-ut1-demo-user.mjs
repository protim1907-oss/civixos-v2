...
const DEMO = {
  email:"ut1.demo@civix250.com", password:"UT1-Demo-2026!",
  full_name:"UT Demo Citizen 1", role:"citizen",
  district:"UT-01", state:"Utah",
  street_address:"350 State St", city:"Salt Lake City", zip_code:"84103",
};
async function main(){
  let userId=null;
