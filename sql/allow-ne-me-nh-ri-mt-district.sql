-- Allow Nebraska (NE), Maine (ME), New Hampshire (NH), Rhode Island (RI), and
-- Montana (MT) districts through the profiles registration gate.
...
BEGIN
  ...
  IF prefix IN ('TX','CA','IL','MD','CO','NV','OH','GA','MI','NY','VA','NC','PA','FL','DC','NJ','AZ','WA','WI','MA','TN','IN','MN','MO','SC','AL','LA','KY','OR','CT','OK','UT','IA','AR','MS','KS','NM','WV','ID','HI','NE','ME','NH','RI','MT') THEN
    RETURN NEW;
  END IF;
