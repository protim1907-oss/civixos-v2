-- Allow Tennessee (TN), Indiana (IN), Minnesota (MN), Missouri (MO), and
-- South Carolina (SC) districts through the profiles registration gate.
...
BEGIN
  ...
  IF prefix IN ('TX', 'CA', 'IL', 'MD', 'CO', 'NV', 'OH', 'GA', 'MI', 'NY', 'VA', 'NC', 'PA', 'FL', 'DC', 'NJ', 'AZ', 'WA', 'WI', 'MA', 'TN', 'IN', 'MN', 'MO', 'SC') THEN
    RETURN NEW;
  END IF;
