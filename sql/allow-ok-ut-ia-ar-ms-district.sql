-- Allow Oklahoma (OK), Utah (UT), Iowa (IA), Arkansas (AR), and Mississippi (MS)
-- districts through the profiles registration gate.
...
BEGIN
  ...
  IF prefix IN ('TX','CA','IL','MD','CO','NV','OH','GA','MI','NY','VA','NC','PA','FL','DC','NJ','AZ','WA','WI','MA','TN','IN','MN','MO','SC','AL','LA','KY','OR','CT','OK','UT','IA','AR','MS') THEN
    RETURN NEW;
  END IF;
