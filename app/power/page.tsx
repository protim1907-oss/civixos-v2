...
const title = "Restore Citizen Power Now — Civix250";
const description =
  "Take action on women's rights, fair voting, and getting corporate money out of politics. Free for verified voters in your congressional district.";

export const metadata: Metadata = {
  title,
  description,
  alternates: { canonical: "https://www.civix250.ai/power" },
  openGraph: {
    title,
    description,
    url: "https://www.civix250.ai/power",
    siteName: "Civix250",
    type: "website",
  },
...
export default function PowerLanding() {
  return (
    <>
      <style>{`
      ...
      <div className="lobby min-h-screen bg-white text-slate-900">
        ...
        {/* HERO — matches Ad 3 headline + palette for tight ad↔page message match */}
          ...
          <div className="mx-auto max-w-6xl">
            <div className="max-w-2xl">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-slate-950">
                Real citizen power, verified and district-based
              </h2>
              <p className="mt-4 text-lg text-slate-600 leading-relaxed">
                Civix250 turns your voter registration into direct, coordinated power on the issues
                that matter — from women&apos;s rights to fair voting to money in politics.
              </p>
            </div>
        ...
        <section className="bg-slate-950 text-white px-5 py-20 md:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight">
              Ready to restore citizen power?
            </h2>
