...
const title = "Lobby Your Reps Directly — Civix250";
const description =
  "Contact your elected officials to propose or support vital bills and constitutional amendments. Free for verified voters in your congressional district.";

export const metadata: Metadata = {
  title,
  description,
  alternates: { canonical: "https://www.civix250.ai/lobby" },
  openGraph: {
    title,
    description,
    url: "https://www.civix250.ai/lobby",
    siteName: "Civix250",
    type: "website",
  },
  ...
  return (
    <>
      ...
      <div className="lobby min-h-screen bg-white text-slate-900">
        ...
        {/* HERO — matches Ad 1 headline + palette for tight ad↔page message match */}
          ...
          <div className="mx-auto max-w-6xl">
            <div className="max-w-2xl">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-slate-950">
                Real influence, verified and district-based
              </h2>
              <p className="mt-4 text-lg text-slate-600 leading-relaxed">
                Civix250 turns your voter registration into direct, coordinated political power —
                inside your district and across the country.
              </p>
            </div>
